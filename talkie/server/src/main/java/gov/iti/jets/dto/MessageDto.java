...
public class MessageDto implements Serializable{
    ...
    public MessageDto(Integer id, UserDto author, String chatId, String fontStyle, String fontColor, double fontSize, boolean bold,
    ...
    public MessageDto(UserDto author, String chatId, String fontStyle, String fontColor, double fontSize, boolean bold,
